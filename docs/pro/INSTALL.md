...
The installer builds the backend, frontend and local `gamepanel-pro-updater:2.0.52` image. Successful installation requires an HTTP health check. It prints the URL and configuration paths, not the password.
