...
- Successful deletion returns to the shared fleet with the chosen node scope and immediately hides the deleted server while inventory refreshes. Remote deletion retains the global server identity and node routing.
