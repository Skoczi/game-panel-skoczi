...
**Game Panel · Skoczi Edition — v1.5.0 · Revision 9 (preview)**

Based on [OVHcloud Game Panel](https://github.com/ovh/game-panel). Technical release: `1.5.0-skoczi.9`.
...
| Use locally owned install/start/update recipes (preview) | [Native Runtime](NATIVE-RUNTIME.md) |
...
| See fork release history | [Changelog](../../CHANGELOG-SKOCZI.md) |

Other documents originate upstream unless marked otherwise. These guides take precedence for fork installation, updates and telemetry.
