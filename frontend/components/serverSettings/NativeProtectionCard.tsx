...
export function NativeProtectionCard({ serverId, supported, checking }: { serverId: number; supported: boolean; checking: boolean }) {
  ...
  return <details className="gp-protection-details rounded-xl border border-gray-200 dark:border-gray-700 p-5 sm:p-6"><summary className="cursor-pointer font-medium">Storage & backup details</summary><AppCard className="gp-protection-content mt-4 border-0 shadow-none" role="region" aria-label="Data protection">
    ...
    {summary && <div className="space-y-6 text-sm">
      ...
      <div className="border-t border-slate-400/15 pt-5">
        <p className="mb-2 font-medium">Latest backup</p>
      ...
      <div className="border-t border-slate-400/15 pt-5">
        <p className="mb-2 font-medium">Backup schedule</p>
      ...
      <div className="border-t border-slate-400/15 pt-5">
        <p className="mb-2 font-medium">Latest restore</p>
