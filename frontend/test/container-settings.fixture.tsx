...
createRoot(document.getElementById('root')!).render(<ThemeProvider><ContainerConfigTab serverId={7} serverName="ReHLDS" serverStatus={location.search.includes('running') ? 'running' : 'stopped'} canEdit canManageEnv canDelete isRoot borderColor="border-slate-700" contentBg="bg-slate-900" inputBg="" inputBorder="" textPrimary="text-slate-100" textSecondary="text-slate-400" hoverBg="" /></ThemeProvider>);
